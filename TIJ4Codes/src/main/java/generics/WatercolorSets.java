...
public class WatercolorSets {
  public static void main(String[] args) {//EnumSet可以从enum Watercolors直接创建Set
    Set<Watercolors> set1 =
      EnumSet.range(BRILLIANT_RED, VIRIDIAN_HUE);//range从enum的BRILLIANT_RED到VIRIDIAN_HUE选取元素组成Set返回
